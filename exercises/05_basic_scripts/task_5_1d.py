...
params = ", ".join(london_co[name_device].keys())
name_param = input(f"Введите имя параметра ({params}): ").lower()

print(london_co[name_device].get(name_param, "Такого параметра нет"))
